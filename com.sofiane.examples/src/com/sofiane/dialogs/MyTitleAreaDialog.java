...
public class MyTitleAreaDialog extends TitleAreaDialog {
	...
	public void creat() {
		super.create();
		setTitle("custum Dialog");
		setMessage("TitelAreaDialog", IMessageProvider.INFORMATION);
	...
	private void createAgeTxT(Composite container) {
		Label lbAge = new Label(container, SWT.NONE);
		lbAge.setText("Age");
